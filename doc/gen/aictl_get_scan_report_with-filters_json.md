## aictl get scan report with-filters json
...
```
aictl get scan report with-filters json <scan-id> [flags]
```

### Examples

```
  aictl get scan report with-filters json <scan-id> -o ./out.json --level-high
  aictl get scan report with-filters json <scan-id> -o ./out.json -f --level-high
```
