## aictl get scan report with-filters json-v2
...
```
aictl get scan report with-filters json-v2 <scan-id> [flags]
```

### Examples

```
  aictl get scan report with-filters json-v2 <scan-id> -o ./out.json-v2 --level-high
  aictl get scan report with-filters json-v2 <scan-id> -o ./out.json-v2 -f --level-high
```
