...
Get scan report in OWASP Maturity format

### Synopsis

Download the scan report in OWASP Maturity format for the given scan id. Project id comes from context or parent -p. Output path via -o; use -f to overwrite.
...
```
  aictl get scan report owaspm <scan-id> -o ./out.xml
