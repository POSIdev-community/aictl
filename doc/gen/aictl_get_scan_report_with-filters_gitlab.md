## aictl get scan report with-filters gitlab
...
```
aictl get scan report with-filters gitlab <scan-id> [flags]
```

### Examples

```
  aictl get scan report with-filters gitlab <scan-id> -o ./out.gitlab --level-high
  aictl get scan report with-filters gitlab <scan-id> -o ./out.gitlab -f --level-high
```
