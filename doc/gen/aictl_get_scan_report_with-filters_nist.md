## aictl get scan report with-filters nist
...
```
aictl get scan report with-filters nist <scan-id> [flags]
```

### Examples

```
  aictl get scan report with-filters nist <scan-id> -o ./out.nist --level-high
  aictl get scan report with-filters nist <scan-id> -o ./out.nist -f --level-high
```

### Options

```
  -h, --help   help for nist
```
