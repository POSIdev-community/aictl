## aictl get scan report with-filters pcidss
...
```
aictl get scan report with-filters pcidss <scan-id> [flags]
```

### Examples

```
  aictl get scan report with-filters pcidss <scan-id> -o ./out.pcidss --level-high
  aictl get scan report with-filters pcidss <scan-id> -o ./out.pcidss -f --level-high
```
