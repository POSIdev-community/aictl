...
type fakeProjectExclusionsUC struct{ called int }

func (f *fakeProjectExclusionsUC) Execute(context.Context) error { f.called++; return nil }

func TestGetProjectExclusionsCmd(t *testing.T) {
	t.Cleanup(resetGetPackageFlags)
	resetGetPackageFlags()
	projectID := uuid.MustParse("11111111-1111-1111-1111-111111111111")
	cfg := mustGetCfg(t)
	uc := &fakeProjectExclusionsUC{}
	ucs := defaultGetUCs()
	ucs.projectExcl = uc
