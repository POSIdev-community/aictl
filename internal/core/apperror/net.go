...
func (e *EmptyResponseError) Error() string {
	...
	return fmt.Sprintf("%s: empty response", e.Resource)
}

func NewEmptyResponseError(resource string) *EmptyResponseError {
	return &EmptyResponseError{Resource: resource}
}
