...
var (
	...
	ErrCannotGetBranchesOnSbom    = errors.New("cannot get branches on an SBOM project; use 'aictl get scans sbom-project'")
	...
	ErrCannotGetSbomScansOnSource = errors.New("cannot get SBOM project scans on a source project; use 'aictl get scans -b'")
	ErrCannotStartSbomScan        = errors.New("cannot start SBOM scan for this project")
	ErrSbomVirtualBranchNotFound  = errors.New("virtual branch not found for SBOM project")
)
