...
func (s *ScanSettings) UpdateFromV19(p *v19.AIProj) error {
	...
	if pygrepSettings := p.PygrepSettings; pygrepSettings != nil {
		if pygrepSettings.RulesDirPath != nil {
			s.PygrepSettings.RulesDirPath = *pygrepSettings.RulesDirPath
		}
		if pygrepSettings.CustomParameters != nil {
			s.PygrepSettings.LaunchParameters = *pygrepSettings.CustomParameters
		}
	}
	...
	s.applyBlackBoxFromV19(p.BlackBoxSettings)
