...
func (a *ClientAI60) GetProjectPolicies(ctx context.Context, projectId uuid.UUID) (io.ReadCloser, error) {
...
func (a *ClientAI60) SetProjectPolicies(ctx context.Context, projectId uuid.UUID, rawJSON []byte) error {
...
func (a *ClientAI60) GetScanPolicyState(ctx context.Context, projectId, scanId uuid.UUID) (policystate.State, error) {
