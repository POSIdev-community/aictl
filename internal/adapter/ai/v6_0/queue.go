...
// Returns cancelled=true when an agent cancel was issued or the active entry disappeared.
func (a *ClientAI60) cancelActiveScan(ctx context.Context, scanResultId uuid.UUID) (bool, error) {
...
func (a *ClientAI60) cancelScanOnAgent(ctx context.Context, agentId uuid.UUID) error {
