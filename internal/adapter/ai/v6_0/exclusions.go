...
func (a *ClientAI60) GetProjectExclusions(ctx context.Context, projectId uuid.UUID) (string, error) {
...
func (a *ClientAI60) SetProjectExclusions(ctx context.Context, projectId uuid.UUID, exclusions string) error {
	body := v6_0.FileFolderExclusionsModel{Exclusions: &exclusions}
