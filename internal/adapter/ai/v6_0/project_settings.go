...
func (a *ClientAI60) GetProjectSettings(ctx context.Context, projectId uuid.UUID) (settings.ScanSettings, error) {
...
func (a *ClientAI60) GetScanAgents(ctx context.Context) ([]scanagent.ScanAgent, error) {
...
func (a *ClientAI60) putPreferredAgentsSettings(ctx context.Context, projectId uuid.UUID, s *settings.ScanSettings) error {
	...
	body := v6_0.PreferredAgentsSettingsModel{
...
func priorityFromSettings(s *settings.ScanSettings) v6_0.Priority {
	if s.Priority == "" {
		return v6_0.PriorityMedium
	}

	return v6_0.Priority(s.Priority)
}

func mapPreferredAgentsFromModel(model v6_0.PreferredAgentsSettingsModel) settings.PreferredAgentsSettings {
...
func mapAgentToScanAgent(model v6_0.Agent) scanagent.ScanAgent {
...
func mapProjectSettingsFromModel(model v6_0.ProjectSettingsModel) settings.ScanSettings {
