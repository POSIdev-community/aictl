...
func (a *ClientAI5x) GetProjectPolicies(ctx context.Context, projectId uuid.UUID) (io.ReadCloser, error) {
...
func (a *ClientAI5x) SetProjectPolicies(ctx context.Context, projectId uuid.UUID, rawJSON []byte) error {
...
func (a *ClientAI5x) GetScanPolicyState(ctx context.Context, projectId, scanId uuid.UUID) (policystate.State, error) {
